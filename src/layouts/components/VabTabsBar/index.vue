    ...
    <el-dropdown @command="handleCommand">
      ...
      <el-dropdown-menu slot="dropdown" class="tabs-more">
        ...
        <el-dropdown-item command="closeOtherstabs">
          <svg-icon icon-class="timescircle"></svg-icon>
          关闭其他
        </el-dropdown-item>
        <el-dropdown-item command="closeLefttabs">
          <svg-icon icon-class="arrowcircleleft"></svg-icon>
          关闭左侧
        </el-dropdown-item>
        <el-dropdown-item command="closeRighttabs">
          <svg-icon icon-class="arrowcircleright"></svg-icon>
          关闭右侧
        </el-dropdown-item>
        <el-dropdown-item command="closeAlltabs">
          <svg-icon icon-class="ban"></svg-icon>
          关闭全部
        </el-dropdown-item>
      </el-dropdown-menu>
    </el-dropdown>
